/**
 * CONTROL TABERNA - Monitor para el encuentro Elisabetha-Lance (identico al original).
 */
public class ControlTaberna {
    ...
    public synchronized void salir(String p) {
        ...
        System.out.println("[TABERNA] " + p + " ha salido.");
        notifyAll();
    }
    ...
    public synchronized void esperarAlOtro(String p) {
        ...
        System.out.println("[TABERNA] *** REENCUENTRO CON CHISPA 100 ***");
        notifyAll();
    }
}
